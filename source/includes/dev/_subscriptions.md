...
----------- | :--------------------------------------------------: | -----: |
application | Application to which the subscription is associated. Read more about the `application` field [here](/reference.html#applications). | String |
env         | Environment to which the subscription is associated. Read more about this field in the [Environments concept section](/reference.html#environments). | String |
...
-------------- | :--------------------------------------------------: | -----: | -----------: |
application    | Application to which the subscription is associated. Read more about the `application` field [here](/reference.html#applications). | String | 'rw'         |
env            | Environment to which the subscription is associated. Read more about this field in the [Environments concept section](/reference.html#environments). | String | 'production' |
