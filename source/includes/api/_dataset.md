...
To create a dataset, you will need an authorization token of an user with role of **MANAGER** or greater. Follow the steps of [this guide to get your token](#generate-your-own-oauth-token) or [check here if you are having problems related with authentication](#troubleshooting-auth-problems).
...
To upload a dataset, you will need an authorization token of an user with role of **MANAGER** or greater. Follow the steps of [this guide to get your token](#generate-your-own-oauth-token) or [check here if you are having problems related with authentication](#troubleshooting-auth-problems).
